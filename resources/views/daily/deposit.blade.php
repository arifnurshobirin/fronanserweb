                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="labeldate" class="col-sm-4 col-form-label">No Deposit :</label>
                            <div class="form-line">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="labeltype" class="col-sm-3 col-form-label">Deposit Type:</label>
                            <div class="form-line">
